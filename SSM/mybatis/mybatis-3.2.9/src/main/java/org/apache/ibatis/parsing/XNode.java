...
public class XNode {
  ...
  /**
   * 其中attributes 属性字段通过parseAttributes()方法解析node对象来获取，主要保存了节点包含的所有属性的键值对
   * @param n node
   * @return Properties
   */
  ...
  /**
   * body属性字段通过parseBody()方法解析node对象来获取，主要处理当前节点的子元素，可能是文本内容，也可能是子标记
   * @param node node
   * @return String
   */
